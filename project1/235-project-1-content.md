...
##### Surfaces & Obstacles
- ![](images/rock.png) Rocks: These surfaces will have different shapes and sizes and will be scattered about in an arena so that the player can bounce off of them. Rocks will allow for a lot of intricate shapes to make walls out of. There can be L-shaped rock formations, triangles, etc... 
- ![](images/log.png) Logs: These will be rectangular surfaces that the player can bounce off of. They will be simpler walls and more common than rocks. 
- ![](images/tree.png) Trees: Circular surfaces for the player to bounce off of. The trees will be represented by a cut down stump, this is just a representation of the tree drawn at a lower y-plane. In reality they will be whole trees and shadows will be drawn below them to communicate this.
- ![](images/bush.png) Bushes: Bouncing on these surfaces will result in the player losing all momentum as they are soft and cushioned. The player will have to avoid bushes in order to keep a momentum combo going.
- ![](images/water.png) Water: The player will be able to charge through water puddles on the ground if they have enough speed built up. Running up to a puddle without enough momentum will result in the player moving at an incredibly slow rate and floating around. The player will be susceptible to an enemy attack when coming out of a puddle.
